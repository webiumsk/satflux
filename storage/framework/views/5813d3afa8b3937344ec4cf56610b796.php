...
<head>
    ...
    <title>Store Report - <?php echo e($store->name); ?></title>
    <style>
...
<body>
    ...
    <p class="subtitle">Sales Report · <?php echo e($dateFrom->format('M j, Y')); ?> – <?php echo e($dateTo->format('M j, Y')); ?></p>
    ...
    <div class="section">
        ...
        <div class="stats-row">
            <div class="stat">
                ...
                <div class="stat-value"><?php echo e(number_format($totalCount)); ?></div>
            </div>
            <div class="stat">
                <div class="stat-label">Total Revenue</div>
                <div class="stat-value"><?php echo e(number_format($totalAmount, 2)); ?> <?php echo e($currency); ?></div>
            </div>
            <div class="stat">
                <div class="stat-label">Avg per Invoice</div>
                <div class="stat-value"><?php echo e($totalCount > 0 ? number_format($totalAmount / $totalCount, 2) : '0'); ?> <?php echo e($currency); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="chart-bar-container">
            <div class="chart-bar-label"><?php echo e($day['date']); ?> · <?php echo e($day['count']); ?> invoices</div>
            <div class="chart-bar-bg">
                <div class="chart-bar-fill" style="width: <?php echo e(min(100, ($day['count'] / $maxCount) * 100)); ?>%;"></div>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right"><?php echo e($item['count']); ?></td>
        ...
        <div class="chart-vertical">
            ...
            <td>
                <div class="chart-bar-col">
                    <div class="chart-bar-val" style="height: <?php echo e($maxCount > 0 ? max(2, ($day['count'] / $maxCount) * 100) : 0); ?>%;"></div>
                </div>
                <div class="chart-bar-date"><?php echo e($day['date']); ?></div>
            </td>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tr></table>
        </div>
    ...
    <p class="footer">Generated by D21 Panel · <?php echo e(now()->format('Y-m-d H:i')); ?> UTC</p>
</body>
</html>
<?php /**PATH /var/www/resources/views/pdf/store-report.blade.php ENDPATH**/ ?>