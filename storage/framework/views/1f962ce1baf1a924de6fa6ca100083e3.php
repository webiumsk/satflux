...
<head>
    ...
    <?php if(config('services.matomo.url') && config('services.matomo.site_id')): ?>
    <!-- Matomo (optional: set MATOMO_URL and MATOMO_SITE_ID in .env) -->
    <script>
      ...
      (function() {
        var u=<?php echo json_encode(rtrim((string) config('services.matomo.url'), '/').'/'); ?>;
        _paq.push(['setTrackerUrl', u+'matomo.php']);
        _paq.push(['setSiteId', <?php echo json_encode(config('services.matomo.site_id'), 15, 512) ?>]);
