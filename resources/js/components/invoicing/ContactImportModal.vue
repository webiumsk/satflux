      ...
      <div class="p-5 space-y-4 overflow-y-auto">
        ...
        >
          <div>
            <h3 class="font-semibold text-gray-800">
              {{ t("invoicing.contact_import_mapping_title") }}
            </h3>
            <p class="text-sm text-gray-600 mt-1">
              {{ t("invoicing.contact_import_mapping_hint") }}
            </p>
          </div>
        ...
        >
          <p class="text-green-700 font-medium">
            {{
              t("invoicing.contact_import_result", {
          ...
          >
            <li v-for="(err, idx) in result.errors" :key="idx">
              {{
                t("invoicing.contact_import_row_error", {
                  row: err.row,
                  message: err.message,
                })
              }}
...
const mappingReady = computed(() =>
  REQUIRED_CONTACT_IMPORT_FIELDS.every(
