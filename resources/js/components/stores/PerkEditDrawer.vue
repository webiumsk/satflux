...
watch(() => props.perk, (newPerk) => {
  if (newPerk) {
    localProduct.value = { ...newPerk };
    imagePreview.value = null;
    selectedFile.value = null;
  } else {
    // Reset to default values for new perk
    localProduct.value = {
      id: '',
      title: '',
      priceType: 'Minimum', // Default to Minimum for perks
      price: 1,
      taxRate: null,
      image: '',
      description: '',
...
async function uploadImage() {
  if (!selectedFile.value || !props.storeId) return;
