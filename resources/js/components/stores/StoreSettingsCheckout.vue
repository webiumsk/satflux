    ...
    >
      ...
      <div class="form-group mb-4">
        ...
        <div class="mt-2 flex flex-wrap items-center gap-3">
          <template v-for="(crit, idx) in form.payment_method_criteria" :key="idx">
      ...
      <div class="space-y-4">
        ...
        <label class="flex items-center gap-3">
          <input v-model="form.celebrate_payment" type="checkbox" class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" />
          <span class="text-sm text-gray-300">{{ t('stores.settings_celebrate_payment') }}</span>
        </label>
        <label class="flex items-center gap-3">
          <input v-model="form.play_sound_on_payment" type="checkbox" class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" />
          <span class="text-sm text-gray-300">{{ t('stores.settings_sounds_on_checkout') }}</span>
        </label>
        <label class="flex items-center gap-3">
          <input v-model="form.show_store_header" type="checkbox" class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" />
          <span class="text-sm text-gray-300">{{ t('stores.settings_show_store_header') }}</span>
        </label>
        <label class="flex items-center gap-3">
          <input v-model="form.show_pay_in_wallet_button" type="checkbox" class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" />
      ...
      <div class="space-y-4">
        <label class="flex items-center gap-3">
          <input v-model="form.on_chain_with_ln_invoice_fallback" type="checkbox" class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" />
        ...
        <label class="flex items-center gap-3">
          <input v-model="form.lightning_amount_in_satoshi" type="checkbox" class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" />
          <span class="text-sm text-gray-300">{{ t('stores.settings_lightning_satoshis') }}</span>
        </label>
        <div class="flex items-start gap-3">
          <input v-model="form.auto_detect_language" type="checkbox" class="mt-1 h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" />
          <div>
        ...
        <label class="flex items-center gap-3">
          <input v-model="form.lazy_payment_methods" type="checkbox" class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" />
          <span class="text-sm text-gray-300">{{ t('stores.settings_lazy_payment_methods') }}</span>
        </label>
        <label class="flex items-center gap-3">
          <input v-model="form.redirect_automatically" type="checkbox" class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" />
      ...
      <div class="space-y-3">
        <label class="flex items-center gap-3">
          <input v-model="form.receipt.enabled" type="checkbox" class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" />
          <span class="text-sm text-gray-300">{{ t('stores.settings_receipt_enabled') }}</span>
        </label>
        <label class="flex items-center gap-3">
          <input v-model="form.receipt.show_payments" type="checkbox" class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" :disabled="!form.receipt.enabled" />
          <span class="text-sm text-gray-300">{{ t('stores.settings_receipt_show_payments') }}</span>
        </label>
        <label class="flex items-center gap-3">
          <input v-model="form.receipt.show_qr" type="checkbox" class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" :disabled="!form.receipt.enabled" />
