    ...
    <div class="space-y-4 pt-8 border-t border-gray-700 mt-8">
      ...
      >
        <label class="flex items-center">
          <input v-model="form.archived" type="checkbox" class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded" :disabled="!canEditArchivedOption" />
