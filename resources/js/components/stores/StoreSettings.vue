  ...
  <div v-else-if="settings" class="space-y-6">
    ...
    <div class="bg-gray-800 shadow-xl rounded-2xl border border-gray-700 overflow-hidden">
      <div class="px-6 py-5 border-b border-gray-700 bg-gray-800/50">
        ...
        <p class="text-sm text-gray-400 mt-1">Manage your store configuration and preferences.</p>
      </div>
      ...
      <div class="px-6 py-8">
        <form @submit.prevent="handleSettingsSubmit" class="space-y-6">
          ...
          <div>
            ...
            <p class="mt-2 text-xs text-gray-500">The recommended price source gets chosen based on the default currency.</p>
          </div>
    ...
    <div class="bg-gray-800 shadow-xl rounded-2xl border border-gray-700 overflow-hidden">
      <div class="px-6 py-5 border-b border-gray-700 bg-gray-800/50">
        <h2 class="text-lg font-bold text-white">Store Logo</h2>
      </div>
      <div class="px-6 py-8">
        <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
           ...
           <div class="flex-1 w-full max-w-sm">
             <label class="block text-sm font-medium text-gray-300 mb-2">
                 {{ storeLogoUrl ? 'Update Logo' : 'Upload Logo' }}
             </label>
             <div class="relative">
                <input
                  ref="logoInputRef"
