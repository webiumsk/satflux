<template>
  ...
  <div v-else class="space-y-6">
    <div class="bg-gray-800 shadow-xl rounded-2xl border border-gray-700 overflow-hidden">
      ...
      <div class="px-6 py-5">
        <div v-if="error" class="rounded-xl bg-red-500/10 border border-red-500/20 p-4 mb-4">
           <div class="flex">
        ...
        <div v-if="exports.length === 0 && !loading" class="text-center py-16 bg-gray-700/30 rounded-xl border border-dashed border-gray-600">
        ...
        <div v-else class="overflow-x-auto rounded-xl border border-gray-700">
          <table class="min-w-full divide-y divide-gray-700">
            ...
            <tbody class="bg-gray-800 divide-y divide-gray-700">
              <tr v-for="exportItem in exports" :key="exportItem.id" class="hover:bg-gray-700/50 transition-colors">
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-white font-mono">{{ exportItem.id }}</td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">{{ exportItem.format || 'CSV' }}</td>
...
function getStatusClass(status: string): string {
  ...
  } else if (statusLower === 'pending' || statusLower === 'running' || statusLower === 'processing') {
