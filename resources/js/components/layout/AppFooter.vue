<template>
  <footer class="shrink-0 border-t border-gray-800 bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-4 lg:px-4 py-3">
      <div class="text-center">
        <div class="flex justify-center gap-4">
          ...
          <p class=" flex items-center gap-3 text-gray-500 hover:text-gray-300 transition-colors"><a
        ...
        <p
          class="text-xs text-gray-600  flex flex-wrap items-center justify-center gap-x-2 gap-y-1 leading-none"
        >
