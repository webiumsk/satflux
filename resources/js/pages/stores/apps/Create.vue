          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <Link :href="`/stores/${store.id}/apps`" class="mr-4 text-gray-400 hover:text-white transition-colors inline-flex">
              ...
              <div class="p-6 sm:p-8">
                <form @submit.prevent="handleSubmit" class="space-y-6">
                  ...
                  <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      >
                        <div :class="[
                          'p-3 rounded-full',
                          form.app_type === 'PointOfSale' ? 'bg-indigo-500 text-white' : 'bg-gray-700 text-gray-400'
                        ]">
                        ...
                        <div v-if="form.app_type === 'PointOfSale'" class="absolute top-3 right-3 text-indigo-500">
                  ...
                  <div>
                    ...
                    />
                    <p v-if="errors.name" class="mt-1 text-sm text-red-400">{{ Array.isArray(errors.name) ? errors.name[0] : errors.name }}</p>
                  </div>

                  <div v-if="errors.message" class="rounded-xl bg-red-500/10 border border-red-500/20 p-4">
                     <div class="flex">
                        ...
                        <div class="text-sm text-red-400">{{ Array.isArray(errors.message) ? errors.message[0] : errors.message }}</div>
                    </div>
                  </div>
                  ...
                  <div class="pt-4 border-t border-gray-700/50 flex items-center justify-end gap-3">
                    ...
                    <button
                      type="submit"
                      :disabled="form.processing || !form.name || !form.app_type"
                    ...
                    >
                      ...
                      {{ form.processing ? t('apps.creating') : t('apps.create_app') }}
                    </button>
                  </div>
...
onMounted(() => {
  // Check if type is provided in query params (Inertia handles this via route params usually, but we can check window.location.search or use page props if we passed them)
  // Cleaner way with Inertia: passed as prop or use page.url
