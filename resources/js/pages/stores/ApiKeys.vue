<template>
  <div class="flex min-h-0 flex-1 overflow-hidden bg-gray-900">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            ...
            <h3 class="text-lg font-medium text-white mb-2">
              {{ t("stores.no_api_keys_yet") }}
            </h3>
            <p class="text-gray-400 mb-6 max-w-sm mx-auto">
              {{ t("stores.create_api_key_description") }}
            </p>
            <button
              @click="openCreateForm"
              class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-xl text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-lg shadow-indigo-600/20 transition-all hover:scale-105"
                ...
                <div class="bg-gray-800 px-4 pt-5 pb-4 sm:p-6">
                  <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                      <h3
                        class="text-lg leading-6 font-bold text-white mb-4"
                        id="modal-title"
                      >
                      ...
                      <form @submit.prevent="handleSubmit" class="space-y-5">
                        ...
                        <div>
                          ...
                          <div
                            class="bg-gray-700/30 rounded-xl p-4 border border-gray-700 space-y-3 max-h-60 overflow-y-auto custom-scrollbar"
                          >
                            <label
                        ...
                        <div>
                          ...
                          <input
                            ...
                            type="url"
                            :placeholder="
                              t('stores.api_key_callback_placeholder')
                            "
                            class="appearance-none block w-full px-4 py-2 border border-gray-600 rounded-xl shadow-sm placeholder-gray-500 text-white bg-gray-700/50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                          />
              ...
              >
                <div class="bg-gray-800 px-4 pt-5 pb-4 sm:p-6">
                  <div class="text-center mb-6">
                    <div
                      class="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-green-500/10 mb-4 border border-green-500/20"
                    >
                      <svg
                  ...
                  <div class="space-y-5">
                    <div>
                      ...
                      <p
                        class="mt-2 text-xs text-amber-500 font-medium flex items-center"
                      >
                        <svg
                          class="w-4 h-4 mr-1"
                          fill="none"
                    ...
                    <div>
                      ...
                      <div class="flex items-center">
                        <input
                          :value="
                            createdApiKey?.store_id || store?.btcpay_store_id
                          "
                          readonly
                ...
                <div
                  class="bg-gray-800/50 border-t border-gray-700 px-4 py-4 sm:px-6"
                >
                  <button
                    @click="closeApiKeyModal"
    ...
    <UpgradeModal
      ...
      :message="
        limit ? t('stores.api_key_limit_reached', { max: limit.max ?? 1 }) : ''
      "
      :limits="
        limit
          ? [{ feature: 'api_keys', current: limit.current, max: limit.max }]
          : []
      "
...
const availablePermissions = [
  ...
  {
    value: "btcpay.store.webhooks.canmodifywebhooks",
    label: "Modify selected stores' webhooks",
  },
