<template>
  <div v-if="storeLoading && !store" class="flex items-center justify-center h-full bg-gray-900">
     <div class="flex flex-col items-center">
        ...
        <p class="text-gray-400">Loading store...</p>
    </div>
  </div>
    ...
    <div class="flex-1 flex flex-col overflow-hidden bg-gray-900 border-l border-gray-800">
      <div class="flex-1 overflow-y-auto">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div class="mb-8">
            <h1 class="text-3xl font-bold text-white">Wallet Connection</h1>
            <p class="mt-2 text-sm text-gray-400">Configure your Lightning wallet connection for <span class="text-indigo-400 font-semibold">{{ store.name }}</span></p>
          </div>
