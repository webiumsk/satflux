      ...
      <div class="flex items-start">
        ...
        <div class="flex-1">
          <p class="text-sm text-yellow-400">
            <strong>Warning:</strong> Payment button should only be used for tips and donations. Using the payment button for e-commerce integrations is not recommended since order relevant information can be modified by the user. For e-commerce, you should use our Greenfield API. If this store process commercial transactions, we advise you to create a separate store before using the payment button.
          </p>
        </div>
        <button
          v-if="showWarning"
    ...
    <div class="space-y-6">
      ...
      <div class="bg-gray-800 shadow-xl rounded-2xl border border-gray-700 overflow-hidden">
        <div class="p-6 md:p-8 space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label for="defaultPaymentMethod" class="block text-sm font-medium text-gray-300 mb-1">
              ...
              >
                ...
                <option value="BTC-LightningNetwork">Bitcoin Lightning Network</option>
              </select>
            </div>

            <div>
              <label for="checkoutDescription" class="block text-sm font-medium text-gray-300 mb-1">
          ...
          <div>
            <label for="orderId" class="block text-sm font-medium text-gray-300 mb-1">
              Order ID
            </label>
            <input
              id="orderId"
        ...
        <div class="p-6 md:p-8 space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="flex items-center bg-gray-900 border border-gray-700 p-4 rounded-xl">           
              ...
              />
              <label for="customizeButtonText" class="ml-3 block text-sm font-medium text-white cursor-pointer">
                Customize Pay Button Text
              </label>
            </div>
            
            <div v-if="form.customizeButtonText">
              <label for="buttonText" class="block text-sm font-medium text-gray-300 mb-1">
                Pay Button Text
              </label>
              <input
                id="buttonText"
            ...
            <div>
              <label for="buttonImageUrl" class="block text-sm font-medium text-gray-300 mb-1">
              ...
              <input
                ...
                type="text"
                placeholder="https://pay.dvadsatjeden.org/img/paybutton/pay.svg"
                class="block w-full px-4 py-3 bg-gray-900 border border-gray-600 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
              />
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-4">
                ...
                <div>
                  <label class="block text-sm font-medium text-gray-300 mb-2">Button Type</label>
                  <div class="space-y-2">
                    <label class="flex items-center bg-gray-900 border border-gray-700 p-4 rounded-xl cursor-pointer hover:bg-gray-800 transition-colors">
                      <input
                      ...
                      />
                      <span class="ml-3 text-sm font-medium text-white">Fixed amount</span>
                    </label>
                    <label class="flex items-center bg-gray-900 border border-gray-700 p-4 rounded-xl cursor-pointer hover:bg-gray-800 transition-colors">
                      <input
                        v-model="form.buttonType"
                        ...
                        class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-600"
                      />
                      <span class="ml-3 text-sm font-medium text-white">Custom amount</span>
                    </label>
                    <label class="flex items-center bg-gray-900 border border-gray-700 p-4 rounded-xl cursor-pointer hover:bg-gray-800 transition-colors">
                      <input
                        v-model="form.buttonType"
                        ...
                        class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-600"
                      />
                      <span class="ml-3 text-sm font-medium text-white">Slider</span>
                    </label>
                  </div>
                </div>

                <div v-if="form.buttonType === 'custom' || form.buttonType === 'slider'" class="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    <label for="minAmount" class="block text-sm font-medium text-gray-300 mb-1">Min</label>
                    <input
                      id="minAmount"
                  ...
                  <div>
                    <label for="maxAmount" class="block text-sm font-medium text-gray-300 mb-1">Max</label>
                    <input
                      id="maxAmount"
                  ...
                  <div>
                    <label for="stepAmount" class="block text-sm font-medium text-gray-300 mb-1">Step</label>
                    <input
                      id="stepAmount"
            ...
            <div v-if="form.buttonType === 'custom' || form.buttonType === 'slider'" class="space-y-3">
            <div class="flex items-center bg-gray-900 border border-gray-700 p-4 rounded-xl">
              <input
                id="simpleInputStyle"
                ...
                class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded transition-colors"
              />
              <label for="simpleInputStyle" class="ml-3 block text-sm font-medium text-white cursor-pointer">
            ...
            <div class="flex items-center bg-gray-900 border border-gray-700 p-4 rounded-xl">
              <input
                ...
                class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded transition-colors"
              />
              <label for="fitButtonInline" class="ml-3 block text-sm font-medium text-white cursor-pointer">
                Fit button inline
              </label>
            </div>
          </div>
              ...
              <div class="mt-6 p-6 bg-gray-900 border border-gray-700 rounded-xl">
                ...
                <div class="flex flex-col items-center gap-4 p-4 bg-gray-800 rounded">
                  <div v-if="form.buttonType === 'custom' || form.buttonType === 'slider'" class="flex items-center gap-2">
                    <button type="button" class="px-3 py-2 bg-gray-700 border border-gray-600 rounded text-white hover:bg-gray-600">-</button>
                    <input
                      type="number"
                  ...
                  <div class="text-sm text-gray-400">{{ form.currency || 'EUR' }}</div>
                  <button
                    type="button"
      ...
      <div class="bg-gray-800 shadow-xl rounded-2xl border border-gray-700 overflow-hidden">
        <div class="p-6 md:p-8 space-y-6">
          <h2 class="text-xl font-bold text-white mb-4">Payment Notifications</h2>
          
          <div>
            <label for="serverIpn" class="block text-sm font-medium text-gray-300 mb-1">
              Server IPN
            </label>
            <input
              id="serverIpn"
              ...
              class="block w-full px-4 py-3 bg-gray-900 border border-gray-600 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
            />
            <p class="mt-1 text-xs text-gray-500">The URL to post purchase data.</p>
          </div>

          <div>
            <label for="emailNotifications" class="block text-sm font-medium text-gray-300 mb-1">
              Email Notifications
            </label>
            <input
              ...
              class="block w-full px-4 py-3 bg-gray-900 border border-gray-600 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
            />
            <div class="mt-3 flex items-center bg-gray-900 border border-gray-700 p-4 rounded-xl">
              <input
                ...
                class="h-5 w-5 text-indigo-600 focus:ring-indigo-500 border-gray-600 bg-gray-800 rounded transition-colors"
              />
              <label for="receiveEmailNotifications" class="ml-3 block text-sm font-medium text-white cursor-pointer">
          ...
          <div>
            <label for="browserRedirect" class="block text-sm font-medium text-gray-300 mb-1">
              Browser Redirect
            </label>
            <input
              id="browserRedirect"
              ...
              class="block w-full px-4 py-3 bg-gray-900 border border-gray-600 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
            />
            <p class="mt-1 text-xs text-gray-500">Where to redirect the customer after payment is complete.</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-gray-800 shadow-xl rounded-2xl border border-gray-700 overflow-hidden">
        <div class="p-6 md:p-8 space-y-6">
          ...
          <div>
            <label for="checkoutQueryString" class="block text-sm font-medium text-gray-300 mb-1">
        ...
        <div class="p-6 md:p-8 space-y-6">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-400 mt-1">Code updates automatically. Copy and paste it into your website HTML.</p>
            </div>
          </div>
          <textarea
            :value="generatedCode"
      ...
      <!-- Alternatives -->
      <div v-if="storeId.value" class="bg-gray-800 shadow-xl rounded-2xl border border-gray-700 overflow-hidden">
        <div class="p-6 md:p-8 space-y-6">
...
const form = ref({
  ...
  buttonText: 'Pay with',
  buttonImageUrl: 'https://pay.dvadsatjeden.org/img/paybutton/pay.svg',
  imageSize: '209x57',
...
const alternativeUrl = computed(() => {
  ...
  if (form.value.checkoutDescription) params.append('description', form.value.checkoutDescription);
...
function generateHtmlCode(): string {
  ...
  const formClass = form.value.fitButtonInline ? 'btcpay-form--inline' : 'btcpay-form--block';
...
`;
  ...
  if (form.value.buttonType === 'custom' || form.value.buttonType === 'slider') {
...
`;
  ...
  html += '        }\n';
  html += '    }\n';
  html += '    document.querySelectorAll(".btcpay-form .plus-minus").forEach(function(el) {\n';
  ...
  html += '        if (isNaN(event.target.value)) root.querySelector(\'.btcpay-input-price\').value = price;\n';
  html += '        const min = parseInt(event.target.getAttribute(\'min\')) || 1;\n';
  ...
  html += '        }\n';
  html += '    }\n';
  html += '    document.querySelectorAll(".btcpay-form .btcpay-input-price").forEach(function(el) {\n';
  html += '        if (!el.dataset.initialized) {\n';
