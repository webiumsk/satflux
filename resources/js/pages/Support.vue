      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        <div class="bg-white border-2 border-gray-200 rounded-lg p-6">
          ...
          <p class="text-gray-600 mb-4">
            For technical issues or questions about the service, contact our support team.
          </p>
          <a
            href="mailto:support@uzol21.org"
        ...
        <div class="bg-white border-2 border-gray-200 rounded-lg p-6">
          ...
          <h3 class="text-xl font-semibold text-gray-900 mb-2">Pricing & Subscriptions</h3>
          <p class="text-gray-600 mb-4">
