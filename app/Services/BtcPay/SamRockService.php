...
class SamRockService
{
    ...
    {
        return $this->client->withUserKey($apiKey, function () use ($btcpayStoreId, $payload) {
    ...
    {
        return $this->client->withUserKey($apiKey, function () use ($btcpayStoreId, $otp) {
    ...
    {
        return $this->client->withUserKey($apiKey, function () use ($btcpayStoreId, $otp, $accept) {
